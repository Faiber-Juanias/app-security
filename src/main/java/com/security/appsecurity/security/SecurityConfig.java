package com.security.appsecurity.security;
...
public class SecurityConfig {
    ...
    private static final String[] ADMIN_RESOURCE = {"/accounts/**", "/cards/**"};
    private static final String ROLE_ADMIN = "VIEW_ADMIN";
    private static final String ROLE_USER = "VIEW_USER";
    ...
    SecurityFilterChain clientSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.oauth2ResourceServer(oauth -> oauth
                .jwt(config -> config.decoder(JwtDecoders.fromIssuerLocation("http://localhost:9000")))
        );
        return http.build();
    }
